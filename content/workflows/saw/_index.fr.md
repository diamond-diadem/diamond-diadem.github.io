...
weight: 2
summary: "Programme conteneurisé pour l'étude de l'adsorption dans les matériaux poreux"
description: "Description du workflow simple-adsorption-workflow pour la simulation Monte Carlo grand canonique de l'adsorption dans les matériaux nanoporeux sur DIAMOND."
...
- **merge** : regrouper dans une seule base de donnéess le résultat de plusieurs expériences indépendantes
- **plot** : tracer les isothermes d'adsorption en utilisant l'interface utilisateur intégrée

Les matériaux disponibles proviennent de la base de données [CoRE MOF 2019](https://doi.org/10.1021/acs.jced.9b00835), une base de données structurelle de MOFs (réseaux organo-métalliques). Cependant l'utilisateur avancé peut utiliser des structures au format CIF, sous réserve d'une étape de curation.
