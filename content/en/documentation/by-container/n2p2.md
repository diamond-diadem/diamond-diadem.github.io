...
weight: 1
description: "Tutorial on using the DIAMOND n2p2 Apptainer container: training a neural network potential for Cu2S and predicting energies and forces."
---
...
- Have downloaded the **n2p2.sif** image [available here](/en/codes/scientific-computing/n2p2/)
- Have downloaded the **input files** [available here](/downloads/n2p2-tutorial-inputs.tar.gz)
