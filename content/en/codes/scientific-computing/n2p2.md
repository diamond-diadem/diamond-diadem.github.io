...
icon: icon-n2p2
weight: 17
description: "N2P2 is a machine learning software for generating neural network interatomic potentials (MLIPs), available as an Apptainer container on DIAMOND."
---
...
{{< link-card title="Learn to use this container image" href="/en/documentation/by-container/n2p2" icon="tabler-icons/outline/package" class="mb-0" >}}
...
{{< link-card title="Download input files" href="/downloads/n2p2-tutorial-inputs.tar.gz" icon="tabler-icons/outline/file-export" >}}