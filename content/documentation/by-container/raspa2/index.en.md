...
<img alt="Screenshot of the representation settings on VMD GUI" src="{{< resource "vmd_representation_settings.png" >}}" />
...
<img alt="Screenshot of a movie frame" src="{{< resource "vmd_movie_frame.png" >}}" />
