...
For Windows users, you can use a [similar solution]({{% ref "/documentation/install/apptainer-windows/" %}}) to that of Apptainer and use Windows Subsystem for Linux (WSL2). However, installing Guix in WSL is far from trivial. We advise you to follow this [guide](https://gist.github.com/giuliano108/49ec5bd0a9339db98535bc793ceb5ab4).
