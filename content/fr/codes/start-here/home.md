...
Pendant l'été 2023, la communauté des matériaux a été sondé via LimeSurvey pour identifier des habitudes de travail. Cela a notamment permis de mettre en lumière un certains nombres de codes utilisés, aussi bien pour le calcul que pour la visualisation (cf ci-dessous). À l'heure actuelle, quasiment $40\%$ des codes cités par la communauté ont été conteneurisés et/ou packagés, couvrant l'ensemble des échelles physiques.
...
- <h4><a href="/documentation/use/apptainer_image/">Apprenez comment utiliser un conteneur</a></h4>
