...
{{< card-grid >}}
{{< link-card title="Site officiel" href="https://www.plumed.org/" target="_blank" icon="outline/world-www" class="mb-0" >}}
{{< link-card title="Documentation officielle" href="https://www.plumed.org/doc" target="_blank" icon="outline/book" class="mb-0" >}}
{{< /card-grid >}}
