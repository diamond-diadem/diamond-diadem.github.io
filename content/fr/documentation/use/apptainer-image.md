...
- L'argument `run` permet de faire naître un conteneur à partir de l'image, d'invoquer la _commande par défaut de l'image_ dans le conteneur puis de détruire le conteneur.
