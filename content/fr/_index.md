...
hero:
  ...
  image:
    alt: >-
      Nuage de mots des codes cités par la communauté DIADEM, classés par
      échelle physique, de l'électronique au macroscopique. 68,2 % d'entre
      eux sont conteneurisés et/ou empaquetés.
    caption: Codes utilisés par la communauté DIADEM, par échelle physique.
  services:
