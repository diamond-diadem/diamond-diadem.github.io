...
Reads data/people.yaml and ensures per-person pages exist for EN and FR:
...
Usage:
  ...
  # Optional flags:
  #   --data-file data/people.yaml     (default shown)
...
def main():
    ...
    ap.add_argument("--data-file", default="data/people.yaml", help="Path to YAML data file (default: data/people.yaml)")
